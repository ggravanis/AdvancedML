...
%	\includegraphics[width=.95\textwidth,left]{.png} %[width=0.6\textwidth]
%	\caption{Αποτελέσματα ταξινόμησης για την περίπτωση της ταξινόμησης με σάκους περιπτώσεων. Ο τελικός αλγόριθμος ταξινόμησης είναι ένα SVM με γραμμικό πυρήνα.}
